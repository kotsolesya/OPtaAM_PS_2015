#include <stdio.h>
 ...
 for(int i = 0;str[i] != '\0'; i++){
     ...
     if(i > 0 && str[i] == '.' && str[i - 1] == '.') { valid = false; break; } 
     else if(i > 0 && str[i] == '@' && !all_presents) { all_presents = 1; } 
     else if(str[i] == '@' && all_presents) { valid = false; break; } 
     else if(isalpha(str[i]) && isdigit(str[i]) && all_presents == 1) { all_presents = 2; } 
     else if(str[i] == '.' && all_presents == 2) { all_presents = 3; } 
     else if(isalpha(str[i]) && all_presents == 3 && str[i + 1] == '\0') { all_presents = 4; }
 }
